		...
		if(NOT EXISTS ${${RESULT_PATH}})
			...
			foreach( F IN LISTS LIB_MASKS )
				if(NOT EXISTS ${LL_RESULT})
					...
					elseif(EXISTS ${LL_ROOT_DIR}/lib/x86_64-linux-gnu/${F})
						set(LL_RESULT ${LL_ROOT_DIR}/lib/x86_64-linux-gnu/${F})
					elseif(EXISTS ${LL_ROOT_DIR}/lib/x86_64-linux-gnu/${LL_LIBNAME}/${F})
						set(LL_RESULT ${LL_ROOT_DIR}/lib/x86_64-linux-gnu/${LL_LIBNAME}/${F})
					endif()
				endif()
			endforeach()			
...
macro(locate_library)
	...
	if(NOT LL_HEADER_ONLY)			
		if(LL_PREFER_STATIC)
			...
			lib_search_location(                      STATIC ID LS LIB_NAME ${LL_LIB_NAME} ROOT_DIR "/usr")
			...
			lib_search_location(                             ID LS LIB_NAME ${LL_LIB_NAME} ROOT_DIR "/usr")
			...
			lib_search_location(               DEBUG  STATIC ID LSD LIB_NAME ${LL_LIB_NAME} ROOT_DIR "/usr")
			...
			lib_search_location(               DEBUG         ID LSD LIB_NAME ${LL_LIB_NAME} ROOT_DIR "/usr")
		else()		
